...
root = Tk()
root.title("Exponential Moving Average")
width = 500
height =300
...
#==============================LABELS=========================================
lbl_title = Label(Top, text = "Configure Exponential Moving Average", font=('arial', 15))
lbl_title.pack(fill=X)
lbl_name = Label(Form, text = "Enter number of periods to calculate the  \n Exponential Moving average for", font=('arial', 14), bd=15)
lbl_name.grid(row=0, sticky="e")
lbl_text = Label(Form)
lbl_text.grid(row=4, columnspan=5)
#==============================ENTRY WIDGETS==================================
EMA = StringVar()
name = Entry(Form, textvariable=EMA, font=(14))
